<?php
/**
Plugin Name: WordPress FTP（WPFTP）
Plugin URI: https://www.laobuluo.com/2186.html
Description: WordPress同步附件内容远程至自建FTP存储中，实现网站数据与静态资源分离，提高网站加载速度。站长互助QQ群： <a href="https://jq.qq.com/?_wv=1027&k=5gBE7Pt" target="_blank"> <font color="red">594467847</font></a>
Version: 1.0
Author: 老部落（By:zdl25）
...
if (substr_count($_SERVER['REQUEST_URI'], '/update.php') <= 0) {
	...
	add_filter('wp_generate_attachment_metadata', 'wpftp_upload_and_thumbs');
}
